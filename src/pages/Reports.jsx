...
import { Search, GraduationCap, Wallet, Users, BookOpen, Award, FileText } from 'lucide-react';
...
const CATEGORIES = {
  ...
  hr: {
    ...
    bg: 'bg-purple-50',
    reports: ['teacher_salary', 'teacher_workload'],
  },
  certifications: {
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <h3 className="text-base font-righteous text-primary group-hover:text-accent transition-colors">
                        {report.title}
                      </h3>
                      <FileText size={16} className="text-secondary-light group-hover:text-accent transition-colors" />
                    </div>
                    {report.description && (
