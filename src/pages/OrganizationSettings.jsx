...
import { Building, Phone, Mail, Globe, MapPin, Eye, EyeOff, Save, FileText, Mail as MailIcon, Tag } from "lucide-react";
    ...
    try {
      ...
      const htmlBody = `
        <div style="font-family:Arial,sans-serif;max-width:800px;margin:0 auto;">
          ...
          <p><strong>Tagline:</strong> ${org.tagline || '—'}</p>   // ← added
    ...
    <>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 space-y-6 max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">
              <Tag size={14} className="inline mr-1" /> Tagline
            </label>
            <input
              name="tagline"
              value={form.tagline}
